## <p align= "center">:man_astronaut: An repository visioning the development of an API using NodeJs who sends emails via smtp requests to you gmail account after a frontend request.</p>
